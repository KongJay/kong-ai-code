package com.jaychou.kongaicode.service.impl;
...
import com.jaychou.kongaicode.ai.AiCodeGenTypeRoutingServiceFactory;
import com.jaychou.kongaicode.constant.AppConstant;
import com.jaychou.kongaicode.core.AiCodeGeneratorFacade;
import com.jaychou.kongaicode.core.builder.VueProjectBuilder;
import com.jaychou.kongaicode.core.handler.StreamHandlerExecutor;
...
import com.jaychou.kongaicode.model.enums.ChatHistoryMessageTypeEnum;
import com.jaychou.kongaicode.model.enums.CodeGenTypeEnum;
import com.jaychou.kongaicode.model.vo.AppVO;
import com.jaychou.kongaicode.model.vo.UserVO;
import com.jaychou.kongaicode.monitor.MonitorContext;
import com.jaychou.kongaicode.monitor.MonitorContextHolder;
import com.jaychou.kongaicode.service.AppService;
import com.jaychou.kongaicode.service.ChatHistoryService;
import com.jaychou.kongaicode.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Long createApp(AppAddRequest appAddRequest, User loginUser) {
        ...
        if(appAddRequest.getMode().equals(0)){
                app.setCodeGenType(CodeGenTypeEnum.CHAT.getValue());
        }else if(appAddRequest.getMode().equals(2)){
                app.setCodeGenType(CodeGenTypeEnum.AGENT.getValue());
        }else{
